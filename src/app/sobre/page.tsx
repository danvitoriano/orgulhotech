export default function Sobre() {
  return (
    <div className="grid text-center lg:mt-12 lg:grid-cols-1 sm:w-12/12 md:w-9/12 lg:w-6/12">
      ...
      <p className="text-lg lg:text-xl mt-4 text-justify">
        ✅ Desenvolvimento profissional: Oportunidades de carreira e networking
        para profissionais LGBTQ+ na tecnologia.
      </p>
      <p className="text-lg lg:text-xl mt-4 text-left">
        ✅ Empreendedorismo LGBTQ+: Incentivando o empreendedorismo e a inovação
        na comunidade LGBTQ+.
      </p>
      ...
      <p className="text-lg lg:text-xl mt-4 text-left">
        ...
        em breve serão anunciadas, todas elas referências em suas áreas e partes
        da comunidade LGBTQ+.
      </p>
      <p className="text-lg lg:text-xl mt-4 text-left text-green-400">
      ...
      <p className="text-lg lg:text-xl mt-4 text-left">
        A conferência é aberta a todos os profissionais LGBTQ+ que atuam na área
