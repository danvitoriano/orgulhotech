export default function Ingressos() {
  return (
    <div className="grid text-center lg:mt-12 lg:grid-cols-1 sm:w-12/12 md:w-9/12 lg:w-6/12">
      ...
      <p className="text-lg lg:text-xl mt-4 text-justify">
        ✅ <b>Data e hora:</b> Sábado, 1 de junho de 2024. Das 9h às 18h.
        <br />✅ <b>Local:</b> Teatro FECAP - Av. da Liberdade, 532 - Liberdade,
        São Paulo/SP. <br />
        <small>
          Entre as estações São Joaquim e Liberdade do metrô. Estacionamento no
          local (pago) <br />
        </small>
      </p>
      <p className="text-lg lg:text-xl mt-4 text-justify text-green-400">
      ...
      <p className="text-sm mt-4 text-left">
        Se você tiver alguma dúvida, ou se sua empresa deseja patrocinar a
        Orgulho Tech Conf, entre em contato conosco através do email{" "}
